...
public class ListGroupFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        GroupsViewAdapter mViewAdapter = new GroupsViewAdapter(groupViewModel.getGroupList().getValue(), navController);
        ...
        binding.groupRefreshView.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
